...
HD_PWD='C:/Users/Brice/Documents/GitHub/RISC-V-Completion-project/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_Black_Box_Translator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_Black_Box_Translator.tcl

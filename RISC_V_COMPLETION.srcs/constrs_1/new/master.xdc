...
#set_module_fpga_dont_touch true -all reg12b

#clocking? Idk this is my first try
create_clock -period 8 -name clk1 -waveform {0.000 4} -add [get_ports sysClk]
#create_generated_clock -name clk2 -source [get_ports sysClk] -divide_by 160 [get_ports { ethPHYClk }]
...
## Buttons
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS12 } [get_ports { btn_c }]; #IO_25_17 Sch=btnc
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS12 } [get_ports { btn_b }]; #IO_0_15 Sch=btnd
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS12 } [get_ports { btn_l }]; #IO_L6P_T0_15 Sch=btnl
#set_property -dict { PACKAGE_PIN C19   IOSTANDARD LVCMOS12 } [get_ports { btn_r }]; #IO_L24P_T3_17 Sch=btnr
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS12 } [get_ports { btn_t }]; #IO_L24N_T3_17 Sch=btnu

...
entity ID_EX_DIV is
	port (
		...
		CSR_file_read_address_0_in : in std_logic_vector(11 downto 0);
		...
		CSR_file_output_1_in : in std_logic_vector(31 downto 0);
...
attribute DONT_TOUCH of behavioral : architecture is "true";
	...
	signal CSR_file_output_1_input_signal : std_logic_vector(31 downto 0);
	...
	signal CSR_file_read_address_0_input_signal : std_logic_vector(11 downto 0);
	...
	signal CSR_file_output_1_output_signal : std_logic_vector(31 downto 0);
	...
	signal CSR_file_read_address_0_output_signal : std_logic_vector(11 downto 0);
...
begin
	...
	--MEM control signals
	data_format_reg : entity riscv.reg3b port map(data_format_input_signal, ones, clock, clear, data_format_output_signal);
	datamem_write_reg : entity riscv.reg1b port map(datamem_write_input_signal, ones, clock, clear, datamem_write_output_signal);
	jump_flag_reg : entity riscv.reg1b port map(jump_flag_input_signal, ones, clock, clear, jump_flag_output_signal);

	--WB control signals
	mux0_sel_reg : entity riscv.reg2b port map(mux0_sel_input_signal, ones, clock, clear, mux0_sel_output_signal);
	reg_file_write_reg : entity riscv.reg1b port map(reg_file_write_input_signal, ones, clock, clear, reg_file_write_output_signal);
	CSR_file_write_reg : entity riscv.reg1b port map(csr_file_write_in, ones, clock, clear, csr_file_write_out);
	reg_file_write_address_reg : entity riscv.reg5b port map(reg_file_write_address_input_signal, ones, clock, clear, reg_file_write_address_output_signal);

	--Data
	register_file_output_0_reg : entity riscv.reg32b port map(register_file_output_0_input_signal, ones, clock, clear, register_file_output_0_output_signal);
	register_file_output_1_reg : entity riscv.reg32b port map(register_file_output_1_input_signal, ones, clock, clear, register_file_output_1_output_signal);
	immediate_reg : entity riscv.reg32b port map(immediate_input_signal, ones, clock, clear, immediate_output_signal);
	instruction_address_reg : entity riscv.reg32b port map(instruction_address_input_signal, ones, clock, clear, instruction_address_output_signal);
	CSR_file_read_output_0_reg : entity riscv.reg32b port map(CSR_file_output_1_input_signal, ones, clock, clear, CSR_file_output_1_output_signal);

	--Read addresses to be given to the forwarding unit
	register_file_read_address_0_reg : entity riscv.reg5b port map(register_file_read_address_0_input_signal, ones, clock, clear, register_file_read_address_0_output_signal);
	register_file_read_address_1_reg : entity riscv.reg5b port map(register_file_read_address_1_input_signal, ones, clock, clear, register_file_read_address_1_output_signal);
	CSR_file_read_address_0_reg : entity riscv.reg12b port map(CSR_file_read_address_0_input_signal, ones, clock, clear, CSR_file_read_address_0_output_signal);
	...
	CSR_file_output_1_input_signal <= CSR_file_output_1_in;
    ...
    CSR_file_read_address_0_input_signal <= CSR_file_read_address_0_in;
	...
	CSR_file_output_1_out <= CSR_file_output_1_output_signal;
    ...
    CSR_file_read_address_0_out <= CSR_file_read_address_0_output_signal;

...
architecture Behavioral of controller is
    type operational_states is (NORMAL, SUPERVISOR, HYPERVISOR, MACHINE);
...
begin
 ...
 next_decoded_cluster <=
        ...
        LOAD    when "-----------------100-----00000--",
        LOAD    when "-----------------101-----00000--",
        STORE   when "-----------------000-----01000--",
        STORE   when "-----------------001-----01000--",
        STORE   when "-----------------010-----01000--",
        BRANCH  when "-----------------000-----11000--",
        BRANCH  when "-----------------001-----11000--",
        BRANCH  when "-----------------100-----11000--",
        BRANCH  when "-----------------101-----11000--",
        BRANCH  when "-----------------110-----11000--",
        BRANCH  when "-----------------111-----11000--",
        JALR    when "-------------------------11001--",
        JAL     when "-------------------------11011--",
        OP_IMM  when "-----------------000-----00100--",
        OP_IMM  when "-----------------001-----00100--",
        OP_IMM  when "-----------------010-----00100--",
        OP_IMM  when "-----------------011-----00100--",
        OP_IMM  when "-----------------100-----00100--",
        OP_IMM  when "-----------------110-----00100--",
        OP_IMM  when "-----------------111-----00100--",
        OP_IMM  when "-0---------------101-----00100--",
        OP_IMM  when "-1---------------101-----00100--",
        OP      when "-0---------------000-----01100--",
        OP      when "-1---------------000-----01100--",
        OP      when "-----------------001-----01100--",
        OP      when "-----------------010-----01100--",
 ...
 ALU_substitute <=
    ...
    --csr_file_write <=internal_CSR_file_write;

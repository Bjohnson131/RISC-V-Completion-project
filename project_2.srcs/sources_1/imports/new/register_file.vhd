...
begin
	register_load_decouple : process (write_control,write_address)
	begin
	...
	reg_x0 : entity riscv.reg32b_falling_edge port map(X"00000000", '1', clock, clear, x0_to_muxes);
	reg_x1 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(1), clock, clear, x1_to_muxes);
	reg_x2 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(2), clock, clear, x2_to_muxes);
	reg_x3 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(3), clock, clear, x3_to_muxes);
	reg_x4 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(4), clock, clear, x4_to_muxes);
	reg_x5 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(5), clock, clear, x5_to_muxes);
	reg_x6 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(6), clock, clear, x6_to_muxes);
	reg_x7 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(7), clock, clear, x7_to_muxes);
	reg_x8 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(8), clock, clear, x8_to_muxes);
	reg_x9 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(9), clock, clear, x9_to_muxes);
	reg_x10 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(10), clock, clear, x10_to_muxes);
	reg_x11 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(11), clock, clear, x11_to_muxes);
	reg_x12 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(12), clock, clear, x12_to_muxes);
	reg_x13 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(13), clock, clear, x13_to_muxes);
	reg_x14 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(14), clock, clear, x14_to_muxes);
	reg_x15 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(15), clock, clear, x15_to_muxes);
	reg_x16 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(16), clock, clear, x16_to_muxes);
	reg_x17 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(17), clock, clear, x17_to_muxes);
	reg_x18 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(18), clock, clear, x18_to_muxes);
	reg_x19 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(19), clock, clear, x19_to_muxes);
	reg_x20 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(20), clock, clear, x20_to_muxes);
	reg_x21 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(21), clock, clear, x21_to_muxes);
	reg_x22 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(22), clock, clear, x22_to_muxes);
	reg_x23 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(23), clock, clear, x23_to_muxes);
	reg_x24 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(24), clock, clear, x24_to_muxes);
	reg_x25 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(25), clock, clear, x25_to_muxes);
	reg_x26 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(26), clock, clear, x26_to_muxes);
	reg_x27 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(27), clock, clear, x27_to_muxes);
	reg_x28 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(28), clock, clear, x28_to_muxes);
	reg_x29 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(29), clock, clear, x29_to_muxes);
	reg_x30 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(30), clock, clear, x30_to_muxes);
	reg_x31 : entity riscv.reg32b_falling_edge port map(write_data, internal_reg_load(31), clock, clear, x31_to_muxes);

	output_1_mux : entity riscv.mux_32_1 port map(
	...
	output_2_mux : entity riscv.mux_32_1 port map(
